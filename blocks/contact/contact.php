...
<section class="">
    <div class="block_content bg-east-bay rounded-[24px] h-auto lg:h-[1030px] flex flex-col justify-center items-center mx-[30px] lg:mx-[75px] px-[40px] py-[75px] relative">
